...
const brands = () => {
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-20 text-center">
            <div className='text-4xl md:text-5xl font-bold text-gray-800 my-10'>
            ...
            <div className="flex flex-col mt-10">
                <div className="flex justify-center flex-wrap mx-auto">
                    <img width={200} height={10} src={Amazon} alt="Amazon logo" />
            ...
            <div className="mt-9 mx-0 md:mx-24 text-base text-gray-900">
                Glitzher tracks thousands of products from Amazon, Hudson's Bay, ShoppersDrugMart, Sephora, Walmart and Wellca.
