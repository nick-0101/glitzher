    ...
    return (
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="mt-10 mb-5">
                ...
                <p>Last updated: April 7, 2021</p>
            </div>

            <div className="mb-10">
                <p>Thank you for choosing to be part of our community at Glitzher LLC ("Company", "we", "us", "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at info@glitzher.com. </p>
                
                <p>When you visit our website http://www.glitzher.com (the "Website"), and more generally, use any of our services (the "Services", which include the Website), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately. </p>
               
                <p>his privacy notice applies to all information collected through our Services (which, as described above, includes our Website), as well as, any related services, sales, marketing or events. </p>
                ...
                <div className="mb-10">
                    <ul>
                        <p className="text-3xl font-bold mt-5 mb-3">Table of Contents</p>
                        <li>
                        ...
                        <li>
                            <a href="#5">5. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?</a>
                        </li>
                        <li>
                            <a href="#6">6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</a>
                        </li>
                        <li>
                            <a href="#7">7. HOW LONG DO WE KEEP YOUR INFORMATION?</a>
                        </li>
                        <li>
                            <a href="#8">8. DO WE COLLECT INFORMATION FROM MINORS?</a>
                        </li>
                        <li>
                    ...
                    <br />
                    <section id="2">
                        <p className="text-3xl font-bold mt-5 mb-3">2. HOW DO WE USE YOUR INFORMATION?</p>
                    ...
                    <section id="3">
                        <p className="text-3xl font-bold mt-5 mb-3">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</p>
                    ...
                    <section id="4">
                        <p className="text-3xl font-bold mt-5 mb-3">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES? </p>
                    ...
                    <section id="6">
                        <p className="text-3xl font-bold mt-5 mb-3">6. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</p>
                    ...
                    <section id="7">
                        <p className="text-3xl font-bold mt-5 mb-3">7. HOW LONG DO WE KEEP YOUR INFORMATION?</p>
                    ...
                    <section id="8">
                        <p className="text-3xl font-bold mt-5 mb-3">8. DO WE COLLECT INFORMATION FROM MINORS?</p>
                        <p>We do not knowingly solicit data from or market to children under 18 years of age. By using the Website, you represent that you are at least 18 or that you are the parent or guardian of such a minor and consent to such minor dependent’s use of the Website. If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at info@glitzher.com. </p>
                    </section>
                    <section id="9">
                        <p className="text-3xl font-bold mt-5 mb-3">9. WHAT ARE YOUR PRIVACY RIGHTS?</p>
                    ...
                    <section id="10">
                        <p className="text-3xl font-bold mt-5 mb-3">10. CONTROLS FOR DO-NOT-TRACK FEATURES</p>
                    ...
                    <section id="11">
                        <p className="text-3xl font-bold mt-5 mb-3">11. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</p>
                    ...
                    <section id="12">
                        <p className="text-3xl font-bold mt-5 mb-3">12. DO WE MAKE UPDATES TO THIS NOTICE?</p>
                    ...
                    <section id="13">
                        <p className="text-3xl font-bold mt-5 mb-3">13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</p>
                        <p>If you have questions or comments about this notice, you may email us at info@glitzher.com.</p>
                    </section>
                </div>
            </div>
            </section>
